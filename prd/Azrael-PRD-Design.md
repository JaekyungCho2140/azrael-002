...
**Read-only Cell** (Phase 1.7 이후):
```css
/* 계산 결과 테이블은 읽기 전용 */
td {
  cursor: default;
  user-select: text; /* 텍스트 복사 가능 */
}

/* 설명/JIRA 설명 컬럼 - 텍스트 선택 시 하이라이트 */
td::selection {
  background: var(--azrael-orange-100);
}
```

**⚠️ Phase 1.7 변경사항**: 계산 결과 테이블(T1/T2/T3)은 읽기 전용입니다. 업무 단계 데이터는 설정 → 업무 단계 관리에서만 수정합니다.
...
┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃  26-02-10 업데이트 일정표   [📋 복사] [JIRA 생성] ┃
┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
┃ # │ 배치 │  마감  │ 테이블 전달 │ JIRA 담당자 │   ┃
┃───┼──────┼────────┼─────────────┼─────────────┤   ┃
┃ 1 │ 정기 │ 01/10  │ 01/15       │ 홍길동       │   ┃
┃ 2 │ 1차  │ 01/20  │ 01/25       │ 김철수       │   ┃
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
(읽기 전용 테이블 - hover 시 행 배경 연한 주황)
※ 업무 단계 수정: 설정 → 업무 단계 관리
...
/* 계산 결과 테이블은 읽기 전용이므로 행 추가 애니메이션 없음 */
```
